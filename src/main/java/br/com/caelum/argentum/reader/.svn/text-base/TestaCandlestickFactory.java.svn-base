...
public class TestaCandlestickFactory {
	...
	public static void main(String[] args){
		...
		/*
		Negocio negocio1 = new Negocio(45.5, 100, hoje);
		...
		*/
		...
		Negocio negocio1 = new Negocio(53.3, 100, hoje);
		Negocio negocio2 = new Negocio(49.8, 100, hoje);
		Negocio negocio3 = new Negocio(45.5, 100, hoje);
